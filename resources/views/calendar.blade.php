...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="{{url('public/images/icon/logo.png')}}" alt="Cool Admin" />
                </a>
            </div>
...
@include('script')
    ...
    <script src="{{asset('public/vendor/fullcalendar-3.10.0/lib/moment.min.js')}}"></script>
    <script src="{{asset('public/vendor/fullcalendar-3.10.0/fullcalendar.js')}}"></script>
