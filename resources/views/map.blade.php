...
@include('script')
    ...
    <script src="{{asset('public/vendor/vector-map/jquery.vmap.brazil.js')}}"></script>
    <script src="{{asset('public/vendor/vector-map/jquery.vmap.europe.js')}}"></script>
    <script src="{{asset('public/vendor/vector-map/jquery.vmap.france.js')}}"></script>
    <script src="{{asset('public/vendor/vector-map/jquery.vmap.germany.js')}}"></script>
    <script src="{{asset('public/vendor/vector-map/jquery.vmap.russia.js')}}"></script>
    <script src="{{asset('public/vendor/vector-map/jquery.vmap.usa.js')}}"></script>
